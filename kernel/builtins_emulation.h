...
#define __FL1(x)				(x == 0 ? 32 : 31 - __builtin_clz((x)))
#define __FF1(x)                (x == 0 ? 32 : __builtin_ctz(x))
...
#ifdef __EMULATION__
#define __builtin_pulp_CoreCount() CONFIG_EMULATION_NB_CORE
#define __builtin_pulp_cnt(x) __builtin_popcount(x)
#endif
