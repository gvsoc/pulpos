...
#if !defined(CONFIG_ISA_PULPV2)
#include "builtins_emulation.h"
...
/* Bit insertion */
#define __BITINSERT(dst, src, size, off) 	__builtin_pulp_binsert((dst), ~(((1<<(size))-1)<<(off)), (src), (((1ULL<<(size))-1)<<(off)), (off))
